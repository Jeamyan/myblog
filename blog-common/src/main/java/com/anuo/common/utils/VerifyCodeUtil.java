...
public class VerifyCodeUtil {
            ...
            switch(type) {
                case 0:
                    while(true) {
                        do {
                            ...
                            t = random.nextInt(10);
                        } while(excludeString != null && excludeString.indexOf(String.valueOf(t)) >= 0);
                ...
                case 1:
                    while(true) {
                        ...
                        } while(excludeString != null && excludeString.indexOf((char)t) >= 0);
    ...
    public static BufferedImage generateImageCode(String textCode, int width, int height, int interLine, boolean randomLocation, Color backColor, Color foreColor, Color lineColor) {
        ...
        for(i = 0; i < textCode.length(); ++i) {
            ...
            graphics.drawString(String.valueOf(textCode.charAt(i)), fx, fy);
